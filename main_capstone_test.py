...
def calculate_new_landmarks(landmarks):
    ...
    hip_right = np.array(keypoints['x'],
                 keypoints['y'])
                 #keypoints[][])
    hip_left = np.array(keypoints['x'],
                keypoints['y'])
                #keypoints['z'])
    ...
    for l in new_landmarks:
        ...
        # new_count.z = l[2]
        count = count+1
    #print(new_keypoints[]['x'])
    #print(new_keypoints[]['y'])
    #print(new_keypoints[].value].z)
...
def landmark_array(landmarks):
    ...
    # foot_left = keypoints[15]['x'],
    #              keypoints[15]['y'],
    #              keypoints[15]['z']
    # heel_left = keypoints[].LEFT_HEEL['x'],
    #              keypoints[].LEFT_HEEL.value[]['y'],
    #              keypoints[].LEFT_HEEL[]['z']
    # ankle_left = keypoints[15]['x'],
    #               keypoints[15]['y'],
    #               keypoints[15]['z']
    # knee_left = keypoints[13]['x'],
    #              keypoints[13]['y'],
    #              keypoints[13]['z']
    # hip_left = keypoints[11]['x'],
    #             keypoints[11]['y'],
    #             keypoints[11]['z']
    # shoulder_left = keypoints[5]['x'],
    #                  keypoints[5]['y'],
    #                  keypoints[5]['z']
    # elbow_left = keypoints[7]['x'],
    #               keypoints[7]['y'],
    #               keypoints[7]['z']
    # wrist_left = keypoints[9]['x'],
    #               keypoints[9]['y'],
    #               keypoints[9]['z']
    # thumb_left = keypoints[]['x'],
    #               keypoints[]['y'],
    #               keypoints[]['z']
    # foot_right = keypoints[]['x'],
    #               keypoints[]['y'],
    #               keypoints[]['z']
    # heel_right = keypoints[].RIGHT_HEEL['x'],
    #               keypoints[]['y'],
    #               keypoints[].RIGHT_HEEL[]['z']
    # ankle_right = keypoints[16]['x'],
    #                keypoints[16]['y'],
    #                keypoints[16]['z']
    # knee_right = keypoints[14]['x'],
    #               keypoints[14]['y'],
    #               keypoints[14]['z']
    # hip_right = keypoints[12]['x'],
    #              keypoints[12]['y'],
    #              keypoints[12]['z']
    # shoulder_right = keypoints[6]['x'],
    #                   keypoints[6]['y'],
    #                   keypoints[6]['z']
    # elbow_right = keypoints[8]['x'],
    #                keypoints[8]['y'],
    #                keypoints[8]['z']
    # wrist_right = keypoints[10]['x'],
    #                keypoints[10]['y'],
    #                keypoints[10]['z']
    # thumb_right = keypoints[]['x'],
    #                keypoints[]['y'],
    #                keypoints[]['z']
    ...
    ankle_left = keypoints[15]['x'], keypoints[15]['y'], keypoints[15]['z']
    knee_left = keypoints[13]['x'],keypoints[13]['y'],keypoints[13]['z']
    hip_left = keypoints[11]['x'],keypoints[11]['y'],keypoints[11]['z']
    shoulder_left = keypoints[5]['x'],keypoints[5]['y'],keypoints[5]['z']
    elbow_left = keypoints[7]['x'],keypoints[7]['y'],keypoints[7]['z']
    wrist_left = keypoints[9]['x'],keypoints[9]['y'],keypoints[9]['z']

    # thumb_left = keypoints[]['x'],
    #               keypoints[]['y'],
    #               keypoints[]['z']

    ankle_right = keypoints[16]['x'],keypoints[16]['y'],keypoints[16]['z']
    knee_right = keypoints[14]['x'],keypoints[14]['y'],keypoints[14]['z']
    hip_right = keypoints[12]['x'],keypoints[12]['y'],keypoints[12]['z']
    shoulder_right = keypoints[6]['x'],keypoints[6]['y'],keypoints[6]['z']
    elbow_right = keypoints[8]['x'],keypoints[8]['y'],keypoints[8]['z']
    wrist_right = keypoints[10]['x'],keypoints[10]['y'],keypoints[10]['z']
    ...
    return la
#def movenet_landmark_array(landmarks):
...
def calculate_all_features(landmarks):
    ...
    #foot_left = keypoints[15]['x'],
     #           keypoints[15].value['y']
    ##heel_left = keypoints[].LEFT_HEEL['x'],
    #            keypoints[].LEFT_HEEL.value['y']
    ankle_left = keypoints[15]['x'],keypoints[15]['y']
    knee_left = keypoints[13]['x'],keypoints[13]['y']
    hip_left = keypoints[11]['x'],keypoints[11]['y']
    shoulder_left = keypoints[5]['x'],keypoints[5]['y']
    elbow_left = keypoints[7]['x'],keypoints[7]['y']
    wrist_left = keypoints[9]['x'],keypoints[9]['y']
   ...
   #foot_right = keypoints[]['x'],
   #             keypoints[]['y']
    #heel_right = keypoints[]['x'],
    #            keypoints[]['y']
    ankle_right = keypoints[16]['x'],keypoints[16]['y']
    knee_right = keypoints[14]['x'],keypoints[14]['y']
    hip_right = keypoints[12]['x'],keypoints[12]['y']
    shoulder_right = keypoints[6]['x'],keypoints[6]['y']
    elbow_right = keypoints[8]['x'],keypoints[8]['y']
    wrist_right = keypoints[10]['x'],keypoints[10]['y']
...
def calculate_squat_features(landmarks):
    ...
    elbow_right = keypoints[8]['x'],keypoints[8]['y'],keypoints[8]['z']
    wrist_right = keypoints[10]['x'],keypoints[10]['y'],keypoints[10]['z']
    eye_left = keypoints[1]['x'],keypoints[1]['y'],keypoints[1]['z']
    eye_right = keypoints[2]['x'],keypoints[2]['y'],keypoints[2]['z']

    shoulder_origin_left = keypoints[5]['x'],1

    shoulder_origin_right = keypoints[6]['x'],1
    ...
    # Foot/Back Angle
    features[6] = calculate_angle_3D_shift(ankle_left, heel_left, hip_left, shoulder_left)
    features[7] = calculate_angle_3D_shift(ankle_right, heel_right, hip_right, shoulder_right)

    # Foot/Femur Angle
    features[8] = calculate_angle_3D_shift(ankle_left, heel_left, knee_left, hip_left)
    features[9] = calculate_angle_3D_shift(ankle_right, heel_right, knee_right, hip_right)

    # Ankle Width
    features[10] = calculate_distance(ankle_left, ankle_right)

    # Foot Angle
    features[11] = calculate_angle_3D_shift(ankle_left, heel_left, heel_right, ankle_right)

    # Face Angle
    features[12] = calculate_angle_3D_shift(ankle_left, heel_left, ear_left, eye_left)
    features[13] = calculate_angle_3D_shift(ankle_right, heel_right, ear_right, eye_right)
...
class LivePoseDetect(Image):
    ...
    def update(self, dt):
        ...
        input_image = tf.cast(self.image, dtype=tf.int32)
        ...
        try:
            ...
            back_angle_left = np.arctan(pose_landmarks_norm[keypoints[5]['x']]/pose_landmarks_norm[keypoints[5]['y']])/np.pi*180

            back_angle_right = np.arctan(pose_landmarks_norm[keypoints[6]['x']]/pose_landmarks_norm[keypoints[6]['y']])/np.pi*180
            ...
            #print(back_angle_l)
            #print(back_angle_r)
            #print(pose_landmarks_norm[keypoints[].value].z)
            if back_angle < 0:
                back_angle = 0
            if back_angle > 100:
                back_angle = 100
            ...
            hip_left = [results.pose_landmarks.landmarkkey[points[11]['x']],
                results.pose_landmarks.landmark[keypoints[11]['y']]]
...
class VideoPoseDetect(Image):
    ...
    def update(self, dt):
        ...
        try:
            ...
            #print(pose_landmarks_norm[keypoints[].value[]['y'])
            #print(pose_landmarks_norm[keypoints[]['y'])


            squat_depth_left = (0.25-pose_landmarks_norm[keypoints.value['y']])/0.4 * 100
            squat_depth_right = (0.25-pose_landmarks_norm[keypoints['y']])/0.4 * 100
            ...
            back_angle_left = np.arctan(pose_landmarks_norm[keypoints['x']]/pose_landmarks_norm[keypoints['y']])/np.pi*180

            back_angle_right = np.arctan(pose_landmarks_norm[keypoints['x']]/pose_landmarks_norm[keypoints['y']])/np.pi*180
            ...
            hip_left = [results.pose_landmarks.landmark[keypoints['x']]],results.pose_landmarks.landmark[keypoints['y']]

            hip_right = [results.pose_landmarks.landmark[keypoints],
                results.pose_landmarks.landmark[keypoints]]
...
class VideoScreen(Screen):
    ...
    def select_path(self, path):
        ...
        if self.ids.video_pose_detect.update_event is not None:
            ...
            self.ids.video_pose_detect.pose = keypoints.Pose(
            model_complexity=2,
            enable_segmentation=True,
            min_detection_confidence=0.5,
            min_tracking_confidence=0.5)
...
class HomeScreen(Screen):
    ...
    #def build(self):
        ...
        #self.pt_search = MDExpansionPanel(panel_cls=MDExpansionPanelOneLine(text=''oga'), icon=''oga')
        #self.pt_list = MDList()
